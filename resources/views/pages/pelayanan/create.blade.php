@extends('layouts.pelayanan.create')

@section('create-pelayanan')

<div class="container-fluid">
                    <h3 class="text-dark mb-4">Tambah Pelayanan</h3>
                    ...
                    @endif
                        ...
                        <div class="card-body">
                           ...
                           <input type="text" class="form-control" name="judul" placeholder="masukkan judul Pelayanan" value="{{old('judul')}}"> 
                           </div>
                           <div class="form-group">

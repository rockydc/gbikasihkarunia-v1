@extends('layouts.pelayanan.index')

@section('content-pelayanan')

<div class="container-fluid">
                    <h3 class="text-dark mb-4">Pelayanan</h3>
                    <div class="card shadow">
                        <div class="card-header py-3"><a class="btn btn-primary" href="{{route('pelayanan.create')}}">Tambah Pelayanan</a></div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    @forelse($items as $item)
                                        <tr>
                                            ...
                                            <a class="btn btn-info" href="{{route('pelayanan.edit',$item->id)}}"><i class="fa fa-pencil">
